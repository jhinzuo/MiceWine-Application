...
import com.miHoYo.Yuanshen.BuildConfig
import com.miHoYo.Yuanshen.R
import com.miHoYo.Yuanshen.activities.DriverManagerActivity.Companion.generateICDFile
import com.miHoYo.Yuanshen.activities.DriverManagerActivity.Companion.generateMangoHUDConfFile
...
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.CPU_AFFINITY
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.DISPLAY_RESOLUTION
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.DISPLAY_RESOLUTION_DEFAULT_VALUE
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.ENABLE_DRI3
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.ENABLE_DRI3_DEFAULT_VALUE
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.ENABLE_MANGOHUD
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.ENABLE_MANGOHUD_DEFAULT_VALUE
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.ENABLE_SERVICES
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.ENABLE_SERVICES_DEFAULT_VALUE
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.FPS_LIMIT
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_BOX64
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_D3DX_RENDERER
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_D3DX_RENDERER_DEFAULT_VALUE
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_DRIVER
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_DRIVER_DEFAULT_VALUE
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_DXVK
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_DXVK_DEFAULT_VALUE
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_DXVK_HUD_PRESET
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_DXVK_HUD_PRESET_DEFAULT_VALUE
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_GL_PROFILE
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_GL_PROFILE_DEFAULT_VALUE
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_MESA_VK_WSI_PRESENT_MODE
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_MESA_VK_WSI_PRESENT_MODE_DEFAULT_VALUE
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_TU_DEBUG_PRESET
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_TU_DEBUG_PRESET_DEFAULT_VALUE
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_VKD3D
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_VKD3D_DEFAULT_VALUE
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_WINED3D
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.SELECTED_WINED3D_DEFAULT_VALUE
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.WINE_ESYNC
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.WINE_ESYNC_DEFAULT_VALUE
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.WINE_LOG_LEVEL
import com.miHoYo.Yuanshen.activities.GeneralSettingsActivity.Companion.WINE_LOG_LEVEL_DEFAULT_VALUE
import com.miHoYo.Yuanshen.core.EnvVars
import com.miHoYo.Yuanshen.core.EnvVars.getEnv
import com.miHoYo.Yuanshen.core.HighlightState
import com.miHoYo.Yuanshen.core.RatPackageManager
import com.miHoYo.Yuanshen.core.RatPackageManager.installRat
import com.miHoYo.Yuanshen.core.ShellLoader.runCommand
import com.miHoYo.Yuanshen.core.ShellLoader.runCommandWithOutput
import com.miHoYo.Yuanshen.core.WineWrapper
import com.miHoYo.Yuanshen.core.WineWrapper.getCpuHexMask
import com.miHoYo.Yuanshen.databinding.ActivityMainBinding
import com.miHoYo.Yuanshen.fragments.AboutFragment
import com.miHoYo.Yuanshen.fragments.AskInstallRatPackageFragment
import com.miHoYo.Yuanshen.fragments.AskInstallRatPackageFragment.Companion.ratCandidate
import com.miHoYo.Yuanshen.fragments.DeleteGameItemFragment
import com.miHoYo.Yuanshen.fragments.EditGamePreferencesFragment
import com.miHoYo.Yuanshen.fragments.FileManagerFragment
import com.miHoYo.Yuanshen.fragments.FileManagerFragment.Companion.refreshFiles
import com.miHoYo.Yuanshen.fragments.FloatingFileManagerFragment
import com.miHoYo.Yuanshen.fragments.SettingsFragment
import com.miHoYo.Yuanshen.fragments.SetupFragment
import com.miHoYo.Yuanshen.fragments.SetupFragment.Companion.abortSetup
import com.miHoYo.Yuanshen.fragments.SetupFragment.Companion.dialogTitleText
import com.miHoYo.Yuanshen.fragments.SetupFragment.Companion.progressBarIsIndeterminate
import com.miHoYo.Yuanshen.fragments.ShortcutsFragment
import com.miHoYo.Yuanshen.fragments.ShortcutsFragment.Companion.saveToGameList
import com.miHoYo.Yuanshen.fragments.ShortcutsFragment.Companion.setIconToGame
import com.miHoYo.Yuanshen.fragments.WineSettingsFragment.Companion.availableCPUs
import com.miHoYo.Yuanshen.utils.DriveUtils
import com.miHoYo.Yuanshen.utils.FilePathResolver
...
class MainActivity : AppCompatActivity() {
    ...
    private suspend fun runXServer(display: String) {
        withContext(Dispatchers.IO) {
            ...
            runCommand(
                "env CLASSPATH=${getClassPath(this@MainActivity)} /system/bin/app_process / com.miHoYo.Yuanshen.CmdEntryPoint $display &> /dev/null"
            )
        }
    }
    ...
    companion object {
        ...
        val appRootDir = File("/data/data/com.miHoYo.Yuanshen/files")
        ...
        const val ACTION_RUN_WINE = "com.miHoYo.Yuanshen.ACTION_RUN_WINE"
        const val ACTION_SETUP = "com.miHoYo.Yuanshen.ACTION_SETUP"
        const val ACTION_INSTALL_RAT = "com.miHoYo.Yuanshen.ACTION_INSTALL_RAT"
        const val ACTION_STOP_ALL = "com.miHoYo.Yuanshen.ACTION_STOP_ALL"
        const val ACTION_SELECT_FILE_MANAGER = "com.miHoYo.Yuanshen.ACTION_SELECT_FILE_MANAGER"
        const val ACTION_SELECT_ICON = "com.miHoYo.Yuanshen.ACTION_SELECT_ICON"
